...
#ifndef OPENGLFRAMEWORK_POWERPLANTMATERIAL_H
#define OPENGLFRAMEWORK_POWERPLANTMATERIAL_H

#include "Material.h"
#include "Uniform.h"

class PowerPlantMaterial : public Material {
public:
    PowerPlantMaterial();
    ~PowerPlantMaterial() = default;
