...
void PhongAnimatedMaterial::ProgramLoaded(GLuint program) {
...
void PhongAnimatedMaterial::BindUniforms(Transform &transform, const Transform &prevTransform) const {
...
PhongAnimatedMaterial::PhongAnimatedMaterial() {
    ShaderSystem::getInstance().AddProgram("material/Phong_Animated", this);
}

void PhongAnimatedMaterial::ReadMaterialFromFile(const std::string &directory) {
