...
glm::vec3 Bone::InterpolateScaling(float animationTime) {
    ...
    float scaleFactor = GetScaleFactor(currKeyPosition.timeStamp,
                                       nextKeyPosition.timeStamp, animationTime);
    glm::vec3 finalScale = MyMath::Lerp(currKeyPosition.scale, nextKeyPosition.scale, scaleFactor);
    return finalScale;
}
...
glm::vec3 Bone::InterpolateScalingGLM(float animationTime) {
    ...
    float scaleFactor = GetScaleFactor(currKeyPosition.timeStamp,
                                       nextKeyPosition.timeStamp, animationTime);
    glm::vec3 finalScale = glm::mix(currKeyPosition.scale, nextKeyPosition.scale, scaleFactor);
    return finalScale;
}
...
glm::vec3 Bone::InterpolateScalingExpo(float animationTime) {
    ...
    float scaleFactor = GetScaleFactor(currKeyPosition.timeStamp,
                                       nextKeyPosition.timeStamp, animationTime);
    glm::vec3 finalScale = MyMath::ExpoLerp(currKeyPosition.scale, nextKeyPosition.scale, scaleFactor);
    return finalScale;
}
